...
In *Aquatic Biology* (Vol. 9. 2010), a study was conducted on the green sea turtles inhabiting the Sound Lagoon of Grand Cayman. The carapace length (cm) was recorded from a sample of 76 green sea turtles. This project uses z-tests/confidence intervals to estimate and make statements about our population mean-the true mean carapace length of all green sea turtles in the lagoon. Get the code [here.](https://github.com/sretcher/hawaii_weather)
